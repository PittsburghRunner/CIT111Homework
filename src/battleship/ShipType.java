 ...
 * ShipType enum
 * 
 * This is an enum which is basically a small 
 * dataset of constant values and a model of the data.
 * In this case its the ship types which never change
 * while the program is executed.
 * But,if you'd like to add one, its easy to do so here.
 * @author ceckles
 */
